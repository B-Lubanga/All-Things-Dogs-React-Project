  ...
  return  (
    ...
    <div className=" flex justify-between bg-displayGrey">
      <div className="flex items-center flex-col w-full px-4 xl:px-0 lg:w-2/5 py-4 md:py-5 lg:py-4 2xl:py-20 overflow-y-auto">
        ...
        <button onClick={ ()=> navigate('/adopt')} className="mt-4 inline-block bg-red-500 hover:bg-red-600 text-white text-base px-6 py-3 rounded-full shadow-md transition">
                Click to Adopt →
        </button>
